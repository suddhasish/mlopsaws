...
class ModelDeployer:
    ...
    def deploy_model(self, model=None, endpoint_name=None, instance_type=None, instance_count=1):
        ...
        try:
            ...
            self.sagemaker_client.create_endpoint_config(
                ...
                ProductionVariants=[{
                    ...
                    'InstanceType': self.config['sagemaker']['endpoint']['instance_type']
                }]
            )
...
class EndpointScaler:
    ...
    def configure_autoscaling(self, endpoint_name, variant_name='AllTraffic',
...
def main():
    ...
    parser.add_argument('--endpoint-name', type=str, default='diabetes-classifier',
