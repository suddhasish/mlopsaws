...
class ModelMonitor:
    ...
    def enable_data_capture(self, endpoint_name, sampling_percentage=100):
        ...
        try:
            ...
            logger.info(f"Data capture enabled. Data will be saved to {data_capture_uri}")
    ...
    def create_baseline(self, endpoint_name, baseline_dataset_path):
        ...
        try:
            ...
            my_monitor = DefaultModelMonitor(
                ...
                volume_size_in_gb=self.config['sagemaker']['monitoring']['volume_size_gb'],
                max_runtime_in_seconds=self.config['sagemaker']['monitoring']['max_runtime_seconds'],
    ...
    def create_monitoring_schedule(self, endpoint_name, baseline_uri, schedule_name=None):
        """
    ...
    def get_monitoring_results(self, schedule_name):
        ...
        try:
            ...
            logger.info(f"Latest execution status: {latest_execution['MonitoringExecutionStatus']}")
...
def main():
    ...
    parser.add_argument('--enable-capture', action='store_true',
                      help='Enable data capture')
    parser.add_argument('--create-baseline', action='store_true',
                      help='Create monitoring baseline')
    parser.add_argument('--create-schedule', action='store_true',
                      help='Create monitoring schedule')
