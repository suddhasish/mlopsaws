...
class FeatureStoreManager:
    ...
    def create_feature_group(self, feature_definitions, record_identifier, event_time_feature):
        ...
        try:
            ...
            logger.warning("SageMaker SDK not available. Feature Store integration skipped.")
        ...
        try:
            if self.feature_group:
                ...
                for record_id in record_ids:
                    record = self.feature_group.get_record(record_identifier_value_as_string=str(record_id))
